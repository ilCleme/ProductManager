...
class Featurevalue
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="QwebCMS\CatalogoBundle\Entity\Product", mappedBy="featurevalues")
     **/
    private $productsWithFeaturevalue;
    
    /**
     *  @ORM\ManyToMany(targetEntity="QwebCMS\CatalogoBundle\Entity\Feature", inversedBy="featurevalues")
     *  @ORM\JoinTable(name="features_featurevalues")
     */
    private $features;

    /**
     * @ORM\ManyToMany(targetEntity="QwebCMS\CatalogoBundle\Entity\Featurevalue")
     ...
     *
     * @param \QwebCMS\CatalogoBundle\Entity\Product $productsWithFeaturevalue
     * @return Featurevalue
     */
    public function addProductsWithFeaturevalue(\QwebCMS\CatalogoBundle\Entity\Product $productsWithFeaturevalue)
    {
     ...
     * @param \QwebCMS\CatalogoBundle\Entity\Product $productsWithFeaturevalue
     */
    public function removeProductsWithFeaturevalue(\QwebCMS\CatalogoBundle\Entity\Product $productsWithFeaturevalue)
    {
     ...
     *
     * @param \QwebCMS\CatalogoBundle\Entity\Featurevalue $featurevalueInherit
     * @return Featurevalue
     */
    public function addFeaturevalueInherit(\QwebCMS\CatalogoBundle\Entity\Featurevalue $featurevalueInherit)
    {
     ...
     * @param \QwebCMS\CatalogoBundle\Entity\Featurevalue $featurevalueInherit
     */
    public function removeFeaturevalueInherit(\QwebCMS\CatalogoBundle\Entity\Featurevalue $featurevalueInherit)
    {
