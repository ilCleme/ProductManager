...
class TblCatalogueProduct
{
     ...
     * @var string
     *
     * @ORM\Column(name="anno_costruzione", type="string", length=255, nullable=true)
     */
    private $anno_costruzione;

    /**
     * @var string
     *
     * @ORM\Column(name="piano", type="string", length=255, nullable=true)
     */
    private $piano;
     ...
     * @var string
     *
     * @ORM\Column(name="mq", type="string", length=255, nullable=true)
     */
    private $mq;
