 ...
 * @ORM\Entity(repositoryClass="IlCleme\CatalogoBundle\Entity\ProductRepository")
 * @Vich\Uploadable
 */
class Product
{
    ...
    /**
     *  @ORM\ManyToMany(targetEntity="IlCleme\CatalogoBundle\Entity\Category", inversedBy="products")
     *  @ORM\JoinTable(name="categories_products")
     */
    private $categories;
    
    /**
     *  @ORM\ManyToMany(targetEntity="IlCleme\CatalogoBundle\Entity\Featurevalue", inversedBy="productsWithFeaturevalue")
