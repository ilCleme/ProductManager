...
class TblCatalogueCategory
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Acme\DemoBundle\Entity\TblCatalogueCategory", mappedBy="categoriesParent")
     **/
    protected $parentOfCategories;

    /**
     * @ORM\ManyToMany(targetEntity="Acme\DemoBundle\Entity\TblCatalogueCategory", inversedBy="parentOfCategories")
     ...
     *
     * @param \Acme\DemoBundle\Entity\TblCatalogueCategory $parentOfCategories
     * @return TblCatalogueCategory
     */
    public function addParentOfCategory(\Acme\DemoBundle\Entity\TblCatalogueCategory $parentOfCategories)
    {
     ...
     * @param \Acme\DemoBundle\Entity\TblCatalogueCategory $parentOfCategories
     */
    public function removeParentOfCategory(\Acme\DemoBundle\Entity\TblCatalogueCategory $parentOfCategories)
    {
     ...
     *
     * @param \Acme\DemoBundle\Entity\TblCatalogueCategory $categoriesParent
     * @return TblCatalogueCategory
     */
    public function addCategoriesParent(\Acme\DemoBundle\Entity\TblCatalogueCategory $categoriesParent)
    {
     ...
     * @param \Acme\DemoBundle\Entity\TblCatalogueCategory $categoriesParent
     */
    public function removeCategoriesParent(\Acme\DemoBundle\Entity\TblCatalogueCategory $categoriesParent)
    {
