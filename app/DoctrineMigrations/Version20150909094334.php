 ...
 */
class Version20150909094334 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        */
        $this->addSql('ALTER TABLE tbl_photo_cat ADD smarty_template_alternativo VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tbl_photo_cat DROP smarty_template_alternativo');
    }
}
