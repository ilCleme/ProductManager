 ...
 */
class Version20150911145126 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE cross_tbl_catalogue_product_x_tbl_catalogue_featurevalue ADD PRIMARY KEY (id_parent, id_item)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE cross_tbl_catalogue_product_x_tbl_catalogue_featurevalue DROP PRIMARY KEY');
    }
}
