 ...
 */
class Version20150708114008 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        */
        $this->addSql('ALTER TABLE tbl_photo CHANGE img_big img_big VARCHAR(255) DEFAULT NULL, CHANGE didascalia didascalia VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tbl_photo CHANGE img_big img_big VARCHAR(255) NOT NULL, CHANGE didascalia didascalia VARCHAR(255) NOT NULL');
    }
}
