 ...
 */
class Version20150706114138 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        //$this->addSql('ALTER TABLE tbl_catalogue_category ADD img VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE tbl_catalogue_featurevalue DROP link, DROP link2');
        ...
        $this->addSql('ALTER TABLE tbl_catalogue_product ADD cod VARCHAR(255) DEFAULT NULL, ADD featured TINYINT(1) NOT NULL, CHANGE position position INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE tbl_photo_cat CHANGE set_loop set_loop TINYINT(1) DEFAULT NULL, CHANGE set_random set_random TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tbl_catalogue_category ADD pub TINYINT(1) NOT NULL, DROP img');
        $this->addSql('ALTER TABLE tbl_catalogue_featurevalue ADD link VARCHAR(255) DEFAULT NULL, ADD link2 VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE tbl_catalogue_product DROP cod, DROP featured, CHANGE position position INT NOT NULL');
        $this->addSql('ALTER TABLE tbl_photo_cat CHANGE set_loop set_loop TINYINT(1) NOT NULL, CHANGE set_random set_random TINYINT(1) NOT NULL');
    }
}
