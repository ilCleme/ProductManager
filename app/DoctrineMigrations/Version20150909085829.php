 ...
 */
class Version20150909085829 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tbl_catalogue_category ADD pub TINYINT(1) NOT NULL');
        /*
    ...
    public function down(Schema $schema)
    {
        ...
        */
        $this->addSql('ALTER TABLE tbl_catalogue_category DROP pub');
        $this->addSql('ALTER TABLE tbl_photo ADD id_tbl_page VARCHAR(255) DEFAULT NULL, ADD datamod DATETIME DEFAULT NULL, ADD link VARCHAR(255) DEFAULT NULL');
    }
}
