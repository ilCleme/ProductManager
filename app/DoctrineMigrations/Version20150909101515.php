 ...
 */
class Version20150909101515 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        */
        $this->addSql('ALTER TABLE tbl_photo_cat CHANGE smarty_template_alternativo smarty_template_alternativo VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tbl_photo_cat CHANGE smarty_template_alternativo smarty_template_alternativo VARCHAR(255) NOT NULL');
    }
}
